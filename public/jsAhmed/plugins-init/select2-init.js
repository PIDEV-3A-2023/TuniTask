...
(function($) {
  ...
  $(".jsAhmed-example-disabled").select2();
  $(".jsAhmed-example-disabled-multi").select2();
  $("#jsAhmed-programmatic-enable").on("click", function () {
      $(".jsAhmed-example-disabled").prop("disabled", false);
      $(".jsAhmed-example-disabled-multi").prop("disabled", false);
  });
  $("#jsAhmed-programmatic-disable").on("click", function () {
      $(".jsAhmed-example-disabled").prop("disabled", true);
      $(".jsAhmed-example-disabled-multi").prop("disabled", true);
  });
  ...
  //select2 themes
  $(".jsAhmed-example-theme-single").select2({
      theme: "classic"
  });
  $(".jsAhmed-example-theme-multiple").select2({
      theme: "classic"
  });


  //ajax remote data
  $(".jsAhmed-data-example-ajax").select2({
      width: "100%",
      ajax: {
  ...
  $(".jsAhmed-example-data-array").select2({
    data: data
  })
  ...
  $(".jsAhmed-programmatic-set-val").on("click", function () {
      $singleUnbind.val("CA").trigger("change");
  });
  
  $(".jsAhmed-programmatic-open").on("click", function () {
      $singleUnbind.select2("open");
  });
  
  $(".jsAhmed-programmatic-close").on("click", function () {
      $singleUnbind.select2("close");
  });
  
  $(".jsAhmed-programmatic-init").on("click", function () {
      $singleUnbind.select2({
          width: "400px"
      });
  });
  
  $(".jsAhmed-programmatic-destroy").on("click", function () {
      $singleUnbind.select2("destroy");
  });


  var $unbindMulti = $(".jsAhmed-example-programmatic-multi").select2();
  $(".jsAhmed-programmatic-multi-set-val").on("click", function () {
      $unbindMulti.val(["CA", "HA"]).trigger("change");
  });
  
  $(".jsAhmed-programmatic-multi-clear").on("click", function () {
