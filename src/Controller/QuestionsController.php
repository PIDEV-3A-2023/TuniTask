...
$flashy->success('Question has been added successfully!', 'http://your-awesome-link.com');
    ...
    public function showAnswers(int $quizId, int $questionId, QuestionsRepository $questionsRepository,QuizsRepository $quizsRepository, AnswersRepository $answersRepository): Response
    {
        ...
        #[Route('/questions/{quizId}/question/{questionId}/answersf', name: 'app_question_answers_freelancer')]
    public function showAnswersFreelancer(int $quizId, int $questionId, QuestionsRepository $questionsRepository,QuizsRepository $quizsRepository, AnswersRepository $answersRepository): Response
    {
        $quiz = $quizsRepository->find($quizId);
        if (!$quiz) {
            throw $this->createNotFoundException('Quiz not found');
