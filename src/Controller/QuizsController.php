...
//        return new JsonResponse($retour);
    ...
    public function view2(QuizsRepository $quizsRepository,Request $request): Response
    {
          $term = $request->query->get('searchInput');
        if ($term === null) {
            $quizs = $quizsRepository->findAll();
...
$flashy->success('Quiz is added successfully!', 'https://your-awesome-link.com');
    ...
    #[Route('/quizs/{id}/openf', name: 'app_quizs_open_freelancer')]
    public function openf(Quizs $quiz, QuestionsRepository $questionsRepository): Response
        {
            $questions = $questionsRepository->findBy(['idQuiz' => $quiz]);
