...
<style type=\"text/cssAhmed\">
";
        // line 147
        echo twig_include($this->env, $context, "@WebProfiler/Collector/time.cssAhmed.twig");
        echo "
</style>
<script>
";
        // line 150
        echo twig_source($this->env, "@WebProfiler/Collector/time.jsAhmed");
        echo "
</script>
";
    ...
    id: \"";
            // line 158
            echo twig_escape_filter($this->env, (isset($context["token"]) || array_key_exists("token", $context) ? $context["token"] : (function () { throw new RuntimeError('Variable "token" does not exist.', 158, $this->source); })()), "jsAhmed", null, true);
            echo "\",
    left: ";
            // line 159
            echo twig_escape_filter($this->env, twig_sprintf("%F", (twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["events"]) || array_key_exists("events", $context) ? $context["events"] : (function () { throw new RuntimeError('Variable "events" does not exist.', 159, $this->source); })()), "__section__", [], "any", false, false, false, 159), "origin", [], "any", false, false, false, 159) - (isset($context["origin"]) || array_key_exists("origin", $context) ? $context["origin"] : (function () { throw new RuntimeError('Variable "origin" does not exist.', 159, $this->source); })()))), "jsAhmed", null, true);
            echo ",
    end: \"";
            // line 160
            echo twig_escape_filter($this->env, twig_sprintf("%F", twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["events"]) || array_key_exists("events", $context) ? $context["events"] : (function () { throw new RuntimeError('Variable "events" does not exist.', 160, $this->source); })()), "__section__", [], "any", false, false, false, 160), "endtime", [], "any", false, false, false, 160)), "jsAhmed", null, true);
            echo "\",
    events: [ ";
            // line 161
...
";
    ...
    name: \"";
                    // line 171
                    echo twig_escape_filter($this->env, $context["name"], "jsAhmed", null, true);
                    echo "\",
    category: \"";
                    // line 172
                    echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["event"], "category", [], "any", false, false, false, 172), "jsAhmed", null, true);
                    echo "\",
    origin: ";
                    // line 173
                    echo twig_escape_filter($this->env, twig_sprintf("%F", twig_get_attribute($this->env, $this->source, $context["event"], "origin", [], "any", false, false, false, 173)), "jsAhmed", null, true);
                    echo ",
    starttime: ";
                    // line 174
                    echo twig_escape_filter($this->env, twig_sprintf("%F", twig_get_attribute($this->env, $this->source, $context["event"], "starttime", [], "any", false, false, false, 174)), "jsAhmed", null, true);
                    echo ",
    endtime: ";
                    // line 175
                    echo twig_escape_filter($this->env, twig_sprintf("%F", twig_get_attribute($this->env, $this->source, $context["event"], "endtime", [], "any", false, false, false, 175)), "jsAhmed", null, true);
                    echo ",
    duration: ";
                    // line 176
                    echo twig_escape_filter($this->env, twig_sprintf("%F", twig_get_attribute($this->env, $this->source, $context["event"], "duration", [], "any", false, false, false, 176)), "jsAhmed", null, true);
                    echo ",
    memory: ";
                    // line 177
                    echo twig_escape_filter($this->env, twig_sprintf("%.1F", ((twig_get_attribute($this->env, $this->source, $context["event"], "memory", [], "any", false, false, false, 177) / 1024) / 1024)), "jsAhmed", null, true);
                    echo ",
    elements: {},
    periods: [";
                    // line 180
            ...
            start: ";
                        // line 182
                        echo twig_escape_filter($this->env, twig_sprintf("%F", twig_get_attribute($this->env, $this->source, $context["period"], "starttime", [], "any", false, false, false, 182)), "jsAhmed", null, true);
                        echo ",
            end: ";
                        // line 183
                        echo twig_escape_filter($this->env, twig_sprintf("%F", twig_get_attribute($this->env, $this->source, $context["period"], "endtime", [], "any", false, false, false, 183)), "jsAhmed", null, true);
                        echo ",
            duration: ";
                        // line 184
                        echo twig_escape_filter($this->env, twig_sprintf("%F", twig_get_attribute($this->env, $this->source, $context["period"], "duration", [], "any", false, false, false, 184)), "jsAhmed", null, true);
                        echo ",
            elements: {}
        },";
                    }
...
";
    ...
    public function macro_display_timeline($__token__ = null, $__events__ = null, $__origin__ = null, ...$__varargs__)
    {
        ...
        <script>";
            ...
            // line 206
            echo twig_escape_filter($this->env, (isset($context["token"]) || array_key_exists("token", $context) ? $context["token"] : (function () { throw new RuntimeError('Variable "token" does not exist.', 206, $this->source); })()), "jsAhmed", null, true);
            echo "')),
                    new Legend(document.getElementById('legend-";
            // line 207
            echo twig_escape_filter($this->env, (isset($context["token"]) || array_key_exists("token", $context) ? $context["token"] : (function () { throw new RuntimeError('Variable "token" does not exist.', 207, $this->source); })()), "jsAhmed", null, true);
            echo "'), theme),
...
<style type=\"text/cssAhmed\">
{{ include('@WebProfiler/Collector/time.cssAhmed.twig') }}
</style>
<script>
{{ source('@WebProfiler/Collector/time.jsAhmed') }}
</script>
{% endblock %}
...
{% endmacro %}
", "@WebProfiler/Collector/time.html.twig", "C:\\Users\\Ahmed\\Desktop\\webtaskk\\vendor1\\symfony\\web-profiler-bundle\\Resources\\views\\Collector\\time.html.twig");
    }
}
