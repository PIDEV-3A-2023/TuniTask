    ...
    public function macro_render_bus_messages($__messages__ = null, $__showBus__ = false, ...$__varargs__)
    {
        ...
        <thead>
            <tr>
                ...
                // line 122
                echo twig_source($this->env, "@WebProfiler/imagesAhmed/icon-minus-square.svg");
                echo "</span>
                        <span class=\"icon icon-open\">";
                // line 123
                echo twig_source($this->env, "@WebProfiler/imagesAhmed/icon-plus-square.svg");
                echo "</span>
                    </a>
                </th>
            </tr>
...
{% macro render_bus_messages(messages, showBus = false) %}
            ...
            <tr>
                ...
                >
                    ...
                    <a class=\"toggle-button\">
                        <span class=\"icon icon-close\">{{ source('@WebProfiler/imagesAhmed/icon-minus-square.svg') }}</span>
                        <span class=\"icon icon-open\">{{ source('@WebProfiler/imagesAhmed/icon-plus-square.svg') }}</span>
                    </a>
                </th>
            </tr>
        </thead>
    ...
    {% endfor %}
{% endmacro %}
", "@WebProfiler/Collector/messenger.html.twig", "C:\\Users\\Ahmed\\Desktop\\webtaskk\\vendor1\\symfony\\web-profiler-bundle\\Resources\\views\\Collector\\messenger.html.twig");
    }
}
