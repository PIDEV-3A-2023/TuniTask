...
class __TwigTemplate_37110b62da61de69d12c394b00ea74c7 extends Template
{
    ...
    public function block_head($context, array $blocks = [])
    {
        ...
        if (twig_get_attribute($this->env, $this->source, (isset($context["collector"]) || array_key_exists("collector", $context) ? $context["collector"] : (function () { throw new RuntimeError('Variable "collector" does not exist.', 4, $this->source); })()), "hasexception", [], "any", false, false, false, 4)) {
            ...
            ";
            // line 7
            echo twig_include($this->env, $context, "@WebProfiler/Collector/exception.cssAhmed.twig");
            echo "
        </style>
    ";
        }
...
{% block head %}
    {% if collector.hasexception %}
        <style>
            ...
            {{ include('@WebProfiler/Collector/exception.cssAhmed.twig') }}
        </style>
    {% endif %}
    {{ parent() }}
{% endblock %}
...
{% block panel %}
    ...
    {% endif %}
{% endblock %}
", "@WebProfiler/Collector/exception.html.twig", "C:\\Users\\Ahmed\\Desktop\\webtaskk\\vendor1\\symfony\\web-profiler-bundle\\Resources\\views\\Collector\\exception.html.twig");
    }
}
