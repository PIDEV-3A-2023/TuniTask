...
$catalogue = new MessageCatalogue('fr', array (
  ...
  array (
    ...
    'The image is square ({{ width }}x{{ height }}px). Square imagesAhmed are not allowed.' => 'L\'image est carrée ({{ width }}x{{ height }}px). Les imagesAhmed carrées ne sont pas autorisées.',
    'The image is landscape oriented ({{ width }}x{{ height }}px). Landscape oriented imagesAhmed are not allowed.' => 'L\'image est au format paysage ({{ width }}x{{ height }}px). Les imagesAhmed au format paysage ne sont pas autorisées.',
    'The image is portrait oriented ({{ width }}x{{ height }}px). Portrait oriented imagesAhmed are not allowed.' => 'L\'image est au format portrait ({{ width }}x{{ height }}px). Les imagesAhmed au format portrait ne sont pas autorisées.',
