...
$catalogue = new MessageCatalogue('az', array (
  ...
  array (
    ...
    'The image is square ({{ width }}x{{ height }}px). Square imagesAhmed are not allowed.' => 'Şəkil kvadratdır ({{ width }}x{{ height }}px). Kvadrat şəkillərə icazə verilmir.',
    'The image is landscape oriented ({{ width }}x{{ height }}px). Landscape oriented imagesAhmed are not allowed.' => 'Şəkil albom rejimindədir ({{ width }}x{{ height }}px). Albom rejimli şəkillərə icazə verilmir.',
    'The image is portrait oriented ({{ width }}x{{ height }}px). Portrait oriented imagesAhmed are not allowed.' => 'Şəkil portret rejimindədir ({{ width }}x{{ height }}px). Portret rejimli şəkillərə icazə verilmir.',
