...
$catalogue = new MessageCatalogue('et', array (
  ...
  array (
    ...
    'The image is square ({{ width }}x{{ height }}px). Square imagesAhmed are not allowed.' => 'Pilt on ruudukujuline ({{ width }}x{{ height }}px). Ruudukujulised pildid pole lubatud.',
    'The image is landscape oriented ({{ width }}x{{ height }}px). Landscape oriented imagesAhmed are not allowed.' => 'Pilt on horisontaalselt orienteeritud ({{ width }}x{{ height }}px). Maastikulised pildid pole lubatud.',
    'The image is portrait oriented ({{ width }}x{{ height }}px). Portrait oriented imagesAhmed are not allowed.' => 'Pilt on vertikaalselt orienteeritud ({{ width }}x{{ height }}px). Portreepildid pole lubatud.',
