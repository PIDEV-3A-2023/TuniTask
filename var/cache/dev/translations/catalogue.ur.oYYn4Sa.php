...
$catalogue = new MessageCatalogue('ur', array (
  ...
  array (
    ...
    'The image is square ({{ width }}x{{ height }}px). Square imagesAhmed are not allowed.' => 'مربع تصاویر کی اجازت نہیں ہے (px{{ height }}x{{ width }})  تصویر مربع ہے',
    'The image is landscape oriented ({{ width }}x{{ height }}px). Landscape oriented imagesAhmed are not allowed.' => 'زمین کی تزئین پر مبنی تصاویر کی اجازت نہیں ہے ({{ width }}x{{ height }}px) تصویر زمین کی تزئین پر مبنی ہے',
    'The image is portrait oriented ({{ width }}x{{ height }}px). Portrait oriented imagesAhmed are not allowed.' => 'پورٹریٹ پر مبنی تصاویر کی اجازت نہیں ہے ({{ width }}x{{ height }}px) تصویر پورٹریٹ پر مبنی ہے',
